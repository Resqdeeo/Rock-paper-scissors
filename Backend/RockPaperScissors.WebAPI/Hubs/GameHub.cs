...
public class GameHub : Hub
{
    ...
    public GameHub(IUserContext userContext, IDbContext dbContext, MongoDbContext mongoDbService, IPublishEndpoint publishEndpoint)
    {
    ...
    public async Task JoinRoom(string gameId)
    {
        ...
        if (game.Creator == currentUser.Id || game.Opponent.Id == currentUser.Id))
        {
